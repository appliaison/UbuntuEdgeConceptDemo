...
public class ImageCellAdapter extends BaseAdapter
{
	...
	private Integer[] mThumbIds = { R.drawable.pictogram1x, R.drawable.pictogram2x,
			R.drawable.pictogram3x, R.drawable.pictogram4x, R.drawable.pictogram5x,
			R.drawable.pictogram6, R.drawable.pictogram7, R.drawable.pictogram8,
			R.drawable.pictogram9 };
